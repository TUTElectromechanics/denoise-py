#!/usr/bin/python3
# -*- coding: utf-8 -*-
"""Denoise measured field strength (H) curves.
...
def scrub(sigma, path, show=False, verbose=False):
    """Denoise a field strength (H) curve.
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="""Denoise measured field strength (H) curves.""", formatter_class=argparse.RawDescriptionHelpFormatter)
